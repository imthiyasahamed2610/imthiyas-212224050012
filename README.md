...
Correct!
  ...
  5. Write a C program that iterates through an array and, within a loop, uses continue  to skip negative elements, 
break when a zero is encountered,and return to exit the program if an element greater than 100 is found
then print the resulting behavior for the array {10, -5, 20, 0, 150, 30}.
